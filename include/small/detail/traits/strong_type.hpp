...
#ifndef SMALL_DETAIL_TRAITS_STRONG_TYPE_HPP
#define SMALL_DETAIL_TRAITS_STRONG_TYPE_HPP
...
namespace strong {
    ...
    namespace impl {
        template <typename T>
        using WhenStrongType = std::enable_if_t<
            is_strong_type<std::decay_t<T>>::value>;
        template <typename T>
        using WhenNotStrongType = std::enable_if_t<
            !is_strong_type<std::decay_t<T>>::value>;
    } // namespace impl
    ...
    namespace impl {
        ...
        STRONG_NODISCARD constexpr auto
        access(T &&t) noexcept -> decltype(value_of(std::forward<T>(t))) {
    ...
    public:
        ...
        operator==(const type &lh, const type &rh) noexcept(
    ...
    namespace impl {
        ...
        public:
            STRONG_NODISCARD
            friend STRONG_CONSTEXPR auto
            operator==(const T &lh, const Other &rh) noexcept(noexcept(
                std::declval<const TT &>() == std::declval<const OT &>()))
                -> decltype(std::declval<const TT &>() == std::declval<const OT &>()) {
                return value_of(lh) == impl::access(rh);
            }
            STRONG_NODISCARD
            friend STRONG_CONSTEXPR auto
            operator==(const Other &lh, const T &rh) noexcept(noexcept(
                std::declval<const OT &>() == std::declval<const TT &>()))
    ...
    namespace impl {
        ...
        {
            static constexpr bool value = std::is_copy_constructible<
        ...
        {
            static constexpr bool value = std::is_move_constructible<
                underlying_type_t<T>>::value;
        ...
        {
            static constexpr bool value = std::is_copy_assignable<
                underlying_type_t<T>>::value;
        ...
        {
            static constexpr bool value = std::is_move_assignable<
                underlying_type_t<T>>::value;
        ...
        struct require_semiregular
            : valid_type<
                  require_copy_constructible<T>::value
    ...
    public:
        ...
        friend STRONG_CONSTEXPR
            ...
            auto
            operator>=(const type &lh, const type &rh) noexcept(noexcept(
    ...
    struct incrementable
    {
        ...
        {
        public:
            friend STRONG_CONSTEXPR T &
            operator++(T &t) noexcept(
                noexcept(++std::declval<T &>().value_of())) {
                ++value_of(t);
                return t;
            }
    ...
    struct boolean
    {
        ...
        {
        public:
            explicit STRONG_CONSTEXPR operator bool() const noexcept(noexcept(
                static_cast<bool>(value_of(std::declval<const T &>())))) {
    ...
    public:
        friend STRONG_CONSTEXPR type &
        operator+=(type &lh, const type &rh) noexcept(
        ...
        friend STRONG_CONSTEXPR type &
        operator*=(type &lh, const T &rh) noexcept(
            noexcept(value_of(lh) *= rh)) {
            value_of(lh) *= rh;
            return lh;
        }
        ...
        friend STRONG_CONSTEXPR type
        operator+(type lh, const type &rh) {
            lh += rh;
            return lh;
        }
        ...
        friend STRONG_CONSTEXPR type
        operator*(type lh, const T &rh) {
            lh *= rh;
            return lh;
        }

        friend STRONG_CONSTEXPR type
        operator*(const T &lh, type rh) {
            rh *= lh;
            return rh;
        }
        ...
        friend STRONG_CONSTEXPR T
        operator/(const type &lh, const type &rh) {
            return value_of(lh) / value_of(rh);
        }
    };
    ...
    class affine_point<D>::modifier<::strong::type<T, Tag, M...>>
    {
        ...
        static_assert(
            ...
            "it must be possible to subtract instances of your underlying "
            "type");
        using diff_type
            = decltype(std::declval<const T &>() - std::declval<const T &>());
    ...
    public:
        STRONG_NODISCARD
        friend STRONG_CONSTEXPR D
        operator-(const type &lh, const type &rh) {
            return D(value_of(lh) - value_of(rh));
        }

        friend STRONG_CONSTEXPR type &
        operator+=(type &lh, const D &d) noexcept(
        ...
        STRONG_NODISCARD
        friend STRONG_CONSTEXPR type
        operator+(type lh, const D &d) {
            return lh += d;
        }

        STRONG_NODISCARD
        friend STRONG_CONSTEXPR type
        operator+(const D &d, type rh) {
            return rh += d;
        }
    ...
    public:
        ...
        operator==(const type &t, std::nullptr_t) noexcept(
            noexcept(std::declval<const TT &>() == nullptr))
        ...
        template <typename TT = T>
        STRONG_NODISCARD friend STRONG_CONSTEXPR auto
        operator==(std::nullptr_t, const type &t) noexcept(
            noexcept(nullptr == std::declval<const TT &>()))
    ...
    struct arithmetic
    {
        ...
        public:
            ...
            friend STRONG_CONSTEXPR T &
            operator+=(T &lh, const T &rh) noexcept(
                noexcept(value_of(lh) += value_of(rh))) {
                value_of(lh) += value_of(rh);
                return lh;
            }
    ...
    struct bitarithmetic
    {
        ...
        public:
            ...
            template <typename C>
            friend STRONG_CONSTEXPR T &
            operator<<=(T &lh, C c) noexcept(noexcept(value_of(lh) <<= c)) {
                value_of(lh) <<= c;
                return lh;
            }
            ...
            template <typename C>
            STRONG_NODISCARD friend STRONG_CONSTEXPR T
            operator<<(T lh, C c) {
                lh <<= c;
                return lh;
            }
    ...
    struct indexed<void>
    {
        ...
        public:
            ...
            operator[](const I &i) const &noexcept(
                noexcept(std::declval<cref>()[impl::access(i)]))
            ...
            template <typename I>
            STRONG_NODISCARD auto
            operator[](const I &i) &noexcept(
                noexcept(std::declval<ref>()[impl::access(i)]))
            ...
            STRONG_NODISCARD auto
            operator[](const I &i) &&noexcept(
                noexcept(std::declval<rref>()[impl::access(i)]))
            ...
            STRONG_NODISCARD auto
            at(const I &i)
                const & -> decltype(std::declval<C>().at(impl::access(i))) {
                auto &self = static_cast<const type &>(*this);
            ...
            STRONG_NODISCARD auto
            at(const I &i) & -> decltype(std::declval<R>().at(
                impl::access(i))) {
                auto &self = static_cast<type &>(*this);
                return value_of(self).at(impl::access(i));
            }
    ...
    public:
        ...
        auto
        operator[](const I &i) const &noexcept(
            noexcept(std::declval<const T &>()[impl::access(i)]))
        ...
        auto
        operator[](const I &i) &noexcept(
            noexcept(std::declval<T &>()[impl::access(i)]))
        ...
        auto
        at(const I &i)
            const & -> decltype(std::declval<const T &>().at(impl::access(i))) {
            auto &self = static_cast<const type &>(*this);
            return value_of(self).at(impl::access(i));
        }
        ...
        STRONG_NODISCARD
        auto
        at(const I &i) & -> decltype(std::declval<T &>().at(impl::access(i))) {
            auto &self = static_cast<type &>(*this);
            return value_of(self).at(impl::access(i));
        }
        ...
        STRONG_NODISCARD
        auto
        at(const I &i) && -> decltype(std::declval<T &&>().at(
            impl::access(i))) {
            auto &self = static_cast<type &>(*this);
            return value_of(std::move(self)).at(impl::access(i));
        }
    ...
    public:
        template <
            typename I,
            typename category = typename std::iterator_traits<
                underlying_type_t<I>>::iterator_category>
        class modifier
    ...
    public:
        ...
        using const_iterator = ::strong::
            type<r_const_iterator, Tag, strong::iterator>;

        iterator
        begin() noexcept(noexcept(std::declval<T &>().begin())) {
            auto &self = static_cast<type &>(*this);
            return iterator{ value_of(self).begin() };
        }

        iterator
        end() noexcept(noexcept(std::declval<T &>().end())) {
            auto &self = static_cast<type &>(*this);
            return iterator{ value_of(self).end() };
        }

        const_iterator
        cbegin() const noexcept(noexcept(std::declval<const T &>().begin())) {
            auto &self = static_cast<const type &>(*this);
            return const_iterator{ value_of(self).begin() };
        }

        const_iterator
        cend() const noexcept(noexcept(std::declval<const T &>().end())) {
            auto &self = static_cast<const type &>(*this);
            return const_iterator{ value_of(self).end() };
        }

        const_iterator
        begin() const noexcept(noexcept(std::declval<const T &>().begin())) {
            auto &self = static_cast<const type &>(*this);
            return const_iterator{ value_of(self).begin() };
        }

        const_iterator
        end() const noexcept(noexcept(std::declval<const T &>().end())) {
            auto &self = static_cast<const type &>(*this);
            return const_iterator{ value_of(self).end() };
        }
    };
    ...
    namespace impl {
        ...
        struct converter
        {
            STRONG_CONSTEXPR explicit operator D() const noexcept(noexcept(
        ...
        {
            STRONG_CONSTEXPR operator D() const noexcept(noexcept(
                static_cast<D>(std::declval<const underlying_type_t<T> &>()))) {
                auto &self = static_cast<const T &>(*this);
                return static_cast<D>(value_of(self));
            }
...
namespace std {
              ...
              std::false_type>
    {
        using type = ::strong::type<T, Tag, M...>;
        decltype(auto)
        operator()(const ::strong::hashable::modifier<type> &t) const
    ...
    struct is_arithmetic<::strong::type<T, Tag, M...>>
        : is_base_of<
              ::strong::arithmetic::modifier<::strong::type<T, Tag, M...>>,
              ::strong::type<T, Tag, M...>>
    {};

} // namespace std
#endif // SMALL_DETAIL_TRAITS_STRONG_TYPE_HPP