...
namespace small {
    namespace detail {
        ...
        /// \note available_code_units will truncate the utf8 size if there isn't enough codepoints for the size
        /// indicated by the first char. Otherwise, only the first char is considered. \return Number of bytes in this
        /// codepoint
        ...
        template <class Char32 = utf32_char_type> constexpr bool is_utf32_continuation(Char32) noexcept {
            return false;
        }
