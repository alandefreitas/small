...
bool operator==(const std::string &lhs, const custom_type &rhs) { return rhs.raw_ == lhs; }
...
bool operator==(const char *lhs, const custom_type &rhs) { return rhs.raw_ == std::string(lhs); }
